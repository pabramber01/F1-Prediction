...
def circuits_plus():
    ...
    circuits_df = pd.read_csv("./f1_prediction/assets/data/kaggle/circuits.csv")
    ...
    circuits_plus_df.to_csv(
        "./f1_prediction/assets/data/scraping/circuits_plus.csv", index=False
    )
...
def circuits_plusplus():
    ...
    circuits_plusplus_df.drop_duplicates("circuitRef", keep="last").to_csv(
        "./f1_prediction/assets/data/scraping/circuits_plusplus.csv", index=False
    )
...
if __name__ == "__main__":
    if not Path("./f1_prediction/assets/data/scraping/weather.csv").is_file():
        weather()
    if not Path("./f1_prediction/assets/data/scraping/circuits_plus.csv").is_file():
        circuits_plus()
    if not Path("./f1_prediction/assets/data/scraping/circuits_plusplus.csv").is_file():
        circuits_plusplus()
